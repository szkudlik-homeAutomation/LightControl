...
C_ASSERT(sizeof(tMessageTypeAddCode) <= CONFIG_COMMUNICATION_PAYLOAD_DATA_SIZE);
...
C_ASSERT(sizeof(tMessageTypeTriggerCode) <= CONFIG_COMMUNICATION_PAYLOAD_DATA_SIZE);
...
C_ASSERT(sizeof(tMessageTypeCodeRecieved) <= CONFIG_COMMUNICATION_PAYLOAD_DATA_SIZE);
